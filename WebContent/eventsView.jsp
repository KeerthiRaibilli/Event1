  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <span class="glyphicon glyphicon-home"style="color: white;"></span>
        ...
        <li><a href="login.jsp"><h4>Login</h4></a></li><br>
        <span class="glyphicon glyphicon-user"style="color: white;"></span>
        <li><a href="register.jsp"><h4>SignUp</h4></a></li><br>
  ...
  <br>
    <div class="row">
        ...
        <div class="col-sm-4">
          <div class="well">
            ...
            <p>Events : HyderabadLIVE<br>
                      : Organisers WorkShop<br>
                      : TEDxhyderabad salon<br>
    ...
    <div class="row">
        <div class="col-sm-4">
          <div class="well">
            <h4>JOB MAINIA</h4>
           <img src="Images/18.jpg" style="width:100%" class="w3-hover-opacity"> 
            <p>Place : KMIT College Of Engineering
               Timings:9:00am-6:00pm<br>
               JobType:BPO's
              </p> 
